  ...
  menu: {
    ...
    menuData: {
      ...
      softDrinks: [
        ...
        { id: "sd8", name: "Water", price: "3 AZN", image: IMG_URL(142), description: "Still or sparkling water.", ingredients: ["Water"], isRecommended: false, prepTime: "1min" },
      ],
      iceTea: [
      ...
      beer: [
        ...
        { id: "b6", name: "Miller", price: "8 AZN", image: IMG_URL(273), description: "American lager.", ingredients: ["Beer"], isRecommended: false, prepTime: "1min" },
      ],
    }
  }
};
